...
{
    hs_dequePointerCheck(pDeque);
    hs_arrayAdd(pDeque -> elements, element);
    ++(pDeque -> size);
}
...
{
    hs_dequePointerCheck(pDeque);
    HS_ELEMENT_TYPE element = hs_arrayRemoveAtIndex(pDeque -> elements, 0);
    --(pDeque -> size);
    return element;
}
...
{
    hs_dequePointerCheck(pDeque);
    hs_arrayAddToIndex(pDeque -> elements, element, 0);
    ++(pDeque -> size);
}
...
{
    hs_dequePointerCheck(pDeque);
    return hs_arrayRemoveAtIndex(pDeque -> elements, --(pDeque-> size));
}
...
{
    hs_dequePointerCheck(pDeque);
    return hs_arrayGetOfIndex(pDeque -> elements, 0);
}
...
{
    hs_dequePointerCheck(pDeque);
    return hs_arrayGetOfIndex(pDeque -> elements, pDeque -> size - 1);
}
